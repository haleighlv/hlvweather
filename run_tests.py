...
from tests.test_generate_summary import (
...
print("Running Tests...\n")
runner.run(
    unittest.TestSuite((unittest.TestLoader().loadTestsFromTestCase(ConvertDateTests)))
)
runner.run(
    unittest.TestSuite((unittest.TestLoader().loadTestsFromTestCase(ConvertTempTests)))
)
runner.run(
    unittest.TestSuite(
...
runner.run(
    unittest.TestSuite((unittest.TestLoader().loadTestsFromTestCase(LoadCSVTests)))
)
runner.run(
    unittest.TestSuite((unittest.TestLoader().loadTestsFromTestCase(FindMinTests)))
)
runner.run(
    unittest.TestSuite((unittest.TestLoader().loadTestsFromTestCase(FindMaxTests)))
)
runner.run(
    unittest.TestSuite(
