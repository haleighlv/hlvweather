...
class GenerateSummaryTests(unittest.TestCase):
    ...
    def test_generate_summary_example_one(self):
        with open(
            "tests/expected_output/example_one_summary.txt", encoding="utf8"
        ) as txt_file:
    ...
    def test_generate_summary_example_two(self):
        with open(
            "tests/expected_output/example_two_summary.txt", encoding="utf8"
        ) as txt_file:
            expected_result = txt_file.read()
    ...
    def test_generate_summary_example_three(self):
        with open(
            "tests/expected_output/example_three_summary.txt", encoding="utf8"
        ) as txt_file:
            expected_result = txt_file.read()
